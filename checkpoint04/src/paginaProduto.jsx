...
function Produto() {
    ...
    const addCarrinho = () => {
        ...
        localStorage.setItem("produto", JSON.stringify(produtoInfo));
            ...
            <div className='body-produto'>
                ...
                <div className='content-produto'>
                    ...
                    <div className='info-produto'>
                        ...
                        <p>
                            Bloom is crafted with a prime blend of 100% pure botanical oils.
                            This new formula enhanced with bakuchiol and prikly pear oil restores, nourishes
                            and visibly improve skin and hair. Naturally scented with notes of rosemary,
                            lavender and dark patchouli. It is suitable for all skin and hair types.
                        </p>
